...
prep-nuget:
	...
	python3 ./flatpak-builder-tools/dotnet/flatpak-dotnet-generator.py nuget-sources.json ../Grayjay.Desktop/Grayjay.Desktop.CEF/Grayjay.Desktop.CEF.csproj --freedesktop 24.08 --dotnet 9
	python3 ./flatpak-builder-tools/dotnet/flatpak-dotnet-generator.py nuget-sources-syncsever.json ../Grayjay.Desktop/SyncServer/SyncClient/SyncClient.csproj --freedesktop 24.08 --dotnet 9
