...
5. Regenerate the two nuget sources files:
   1. From an x86 machine, run `python3 ./flatpak-builder-tools/dotnet/flatpak-dotnet-generator.py nuget-sources.json <path to your checked out grayjay source repo>/Grayjay.Desktop.sln --freedesktop 24.08 --dotnet 8 --only-arches x86_64` to update `nuget-sources.json`
   2. From an arm64 machine, run `python3 ./flatpak-builder-tools/dotnet/flatpak-dotnet-generator.py nuget-sources-arm.json <path to your checked out grayjay source repo>/Grayjay.Desktop.sln --freedesktop 24.08 --dotnet 8 --only-arches aarch64` to update `nuget-sources-arm.json`
